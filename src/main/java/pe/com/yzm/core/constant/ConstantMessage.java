...
public class ConstantMessage {
     ...
     */
    public final String HEADERS_INVALID_MSG = "Request headers invalid";

    /**
     * Message indicating that the request headers are valid.
     */
    public final String HEADERS_VALID_MSG = "Request headers valid.";

    /**
     * Message indicating that the Transaction-Id header is required.
     */
    public final String HEADERS_REQUIRED_TRANSACTION_ID = "Transaction-Id is required";
     ...
     */
    public final String LOG_PARAMS_IN_HEADERS_BODY = "%s : %d - [idTx=%s] Datos de entrada request: Headers=%s Body=%s";
     ...
     */
    public final String LOG_PARAMS_OUT_HEADERS_BODY = "%s : %d - [idTx=%s] Datos de salida response: Headers=%s Body=%s";

    /**
     * Format string for logging the error data.
     * It includes placeholders for the class name, line number, transaction ID, application ID, headers, and body.
     */
    public final String LOG_ERROR = "%s : %d - [idTx=%s] Ocurrio un error: %s";

    public final String GENERIC_MESSAGE = "Ocurrio un error inesperado";
}